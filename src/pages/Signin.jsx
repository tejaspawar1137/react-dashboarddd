              ...
              <form>
                <div className="space-y-4">
                  <div>
                    ...
                    <input name='email' value={email} onChange={e => setEmail(e.target.value)} id="email" className="form-input w-full" type="email" />
                  </div>
                  <div>
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  <a className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3" onClick={SignIn} >Sign In</a>
                </div>
              </form>
              {/* Footer */}
