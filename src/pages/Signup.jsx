              ...
              <form>
                <div className="space-y-4">
                  <div>
                    ...
                    <input name='email' value={email} onChange={e => setEmail(e.target.value)} id="password" className="form-input w-full" type="email" autoComplete="on" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="name">Full Name <span className="text-rose-500">*</span></label>
					<input name='name' value={name} onChange={e => setName(e.target.value)} id="name" className="form-input w-full" type="text" autoComplete="on" />
                  </div>
                  <div>
                  ...
                  <div>
					...
					<input name='password' value={password} onChange={e => setPassword(e.target.value)} id="password" className="form-input w-full" type="password" autoComplete="on" />
                  </div>
                </div>
                <div className="flex items-center justify-between mt-6">
                  ...
                  <a className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3 whitespace-nowrap" onClick={submit} >Sign Up</a>
                </div>
              </form>
              {/* Footer */}
