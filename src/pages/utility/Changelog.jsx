...
function Changelog() {
  ...
  const handleSubmit = (e) => {
	...
	const addUsers = async () => {
	  const contactRef = doc(collection(db, "Changelog"));
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
              ...
              <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                  ...
                  <span className="ml-2" onClick={openModal}>Add Entry</span>
                ...
                <div className="xl:-translate-x-16">
                    ...
                    <div className="xl:flex">
                      <div className="w-32 shrink-0">
                        <div className="text-xs font-semibold uppercase text-slate-400 xl:leading-8">{item.data.date}</div>
                      </div>
