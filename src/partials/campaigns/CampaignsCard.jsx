    ...
    <div className="col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
      <div className="flex flex-col h-full p-5">
        <header>
          {/* <div className="flex items-center justify-between">
            ...
            <div className="flex shrink-0 -space-x-3 -ml-px">
                      ...
                      <img className="rounded-full border-2 border-white box-content" src="http://source.unsplash.com/random" width="48" height="48"   />
        ...
        <footer className="mt-5">
          <div className="text-sm font-medium text-slate-500 mb-2">{props.date} <span className="text-slate-400">-&gt;</span> {props.date}</div>
